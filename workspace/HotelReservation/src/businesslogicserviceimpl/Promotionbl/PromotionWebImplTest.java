...
public class PromotionWebImplTest {
	...
	public void setUp() throws Exception {
		web1 = new PromotionWebPO(PromotionWebType.VIP_LEVEL_PROMOTION,"vip", null, null, "80%");
		web2 = new PromotionWebPO(PromotionWebType.VIP_CIRCLE_PROMOTION,"vip", null, null, "70%");
		web3 = new PromotionWebPO(PromotionWebType.WEB_CUSTOM_PROMOTION,"vip","2016/11/05", "2016/11/11", "50%");
		//web要添加增加方法
