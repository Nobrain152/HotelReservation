...
public class HotelReserveBLServiceImplTest {
	HotelReserveBLServiceImpl impl;
	...
	@Before
	public void setUp() {
		impl = new HotelReserveBLServiceImpl();
		...
		order1 = new OrderOnUserVO(new User("GYF",100,"15150158583","151250047@smail.nju.edu.cn"),
				OrderState.UNEXECUTED,105, "2016-10-15 24:00",RoomType.ROOM_STANDARD,1,1,true);
		order2 = new OrderOnUserVO(new User("GYF",100,"15150158583","151250047@smail.nju.edu.cn"),
				OrderState.ABNORMAL,105, "2016-10-16 24:00",RoomType.ROOM_BUSINESS,1,1,false);
		
		orderMsg1=new OrderOnUserMsg(new User("GYF",100,"15150158583","151250047@smail.nju.edu.cn"),
				OrderState.UNEXECUTED,105, "2016-10-15 24:00",RoomType.ROOM_STANDARD,1,1,true);
		orderMsg2 = new OrderOnUserMsg(new User("GYF",100,"15150158583","151250047@smail.nju.edu.cn"),
				OrderState.ABNORMAL,105, "2016-10-16 24:00",RoomType.ROOM_BUSINESS,1,1,false);
